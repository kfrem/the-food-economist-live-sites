...
const BOOKING_SITE = 'EPR desk';
const BOOKING_SERVICE_DEFAULT = 'EPR prepared call';
...
function booking_create(): void {
    ...
    tfe_automation_record_booking('epr', $booking, 'booked');
    booking_json([
        'ok' => true,
...
function booking_cancel_page(string $token, bool $confirmed): void {
    ...
    if ($found) {
        ...
        tfe_automation_record_booking('epr', $found, 'cancelled');
